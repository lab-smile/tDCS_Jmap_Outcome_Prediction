...
% Special-case for subject 301428 (custom dataBaseDir).
% For this subject:
%   - copies T1.nii into ./301428/ (if exists)
%   - copies T1_tDCSLAB_Jbrain.nii into ./301428/
%   - reads direction field from T1_tDCSLAB_emag.nii (assumed 4D, 3 comps)
%   - creates Jbrain component maps: Jx Jy Jz = Jbrain * (E_dir)
%
% Outputs:
%   ./301428/
%       - T1.nii
...
for s = 1:numel(subject_ids)
    ...
    % Special case: subDataDir is directly the provided dataBaseDir
